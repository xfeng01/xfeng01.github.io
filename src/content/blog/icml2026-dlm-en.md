...
| 3 | [**Breaking the Factorization Barrier in Diffusion Language Models**](https://arxiv.org/abs/2603.00045)<br>*Ian Li, Zilei Shao, Benjie Wang, Rose Yu, Guy Van den Broeck, Anji Liu* | poster | **The most seriously underrated paper this year.** It directly addresses the fundamental limitation of parallel generation: the conditional-independence assumption implicit in predicting multiple tokens simultaneously. Rather than “adding another planner,” it tackles the factorization barrier with tractable probabilistic modeling. Many decoding tricks operate beneath this barrier |
